...
export default function H5Layout({
  ...
  const tabItems: TabItem[] = [
    ...
    },
    {
      ...
      activeIcon: (
        <svg className="w-[22px] h-[22px]" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.092 5.653a.75.75 0 01.326-1.013A5.25 5.25 0 0118.75 8.25a.75.75 0 01-1.5 0 3.75 3.75 0 00-5.145-3.472.75.75 0 01-1.013-.326zM7.665 9.598a.75.75 0 01-.326 1.013 3.75 3.75 0 005.145 3.472.75.75 0 11.582 1.339A5.25 5.25 0 016.652 9.924a.75.75 0 011.013-.326z" />
          <path fillRule="evenodd" d="M3.97 8.878a7.5 7.5 0 011.172-2.259l-1.414-1.414a.75.75 0 111.06-1.06l1.415 1.414A7.5 7.5 0 0119.278 11.7l1.414 1.414a.75.75 0 11-1.06 1.06l-1.415-1.414A7.5 7.5 0 013.97 8.878zM5.403 8.13a6 6 0 1011.314.002A6 6 0 005.403 8.13z" clipRule="evenodd" />
        </svg>
      ),
      adminOnly: true
    },
