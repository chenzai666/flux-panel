...
export default function AdminLayout({
  ...
  return (
         ...
         <div className="px-3 py-3 h-14 flex items-center">
           <div className="flex items-center gap-2 w-full">
             ...
             <div className="flex-1 min-w-0">
               <h1 className="text-sm font-semibold text-[#1f1b16] overflow-hidden whitespace-nowrap">{siteConfig.name}</h1>
        ...
        <div className="px-4 py-2 pb-4 mt-auto flex-shrink-0">
          <div className="text-center">
             <p className="text-xs brand-muted">
               Powered by{' '}
               <span className="brand-accent">Aurora Panel</span>
             </p>
          </div>
        </div>
      </aside>
      ...
      <div className={`flex flex-col flex-1 ${isMobile ? 'min-h-0' : 'h-full overflow-hidden'}`}>
          ...
          <div className="flex items-center gap-3">
            {/* 用户菜单 */}
             <Dropdown placement="bottom-end">
               <DropdownTrigger>
                  <Button variant="light" className="text-sm font-medium text-[#3d352d]">
                   {username}
        ...
        {/* 主内容 */}
        <main className={`app-content flex-1 ${isMobile ? '' : 'overflow-y-auto'} p-3 sm:p-4`}>
          {children}
        </main>
      </div>
