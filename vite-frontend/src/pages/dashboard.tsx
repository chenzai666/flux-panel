...
import { getUserPackageInfo, getConfigs } from "@/api";
           ...
           <Card className="mb-4 border border-[#FAC775] dark:border-[#5d3a00] bg-[#FAEEDA] dark:bg-[#2d1f00] shadow-none rounded-xl">
             <CardBody className="p-3 lg:p-4">
               <div className="flex items-start gap-3">
                 <div className="p-1.5 bg-[#FAC775]/40 dark:bg-[#5d3a00]/60 rounded-lg flex-shrink-0 mt-0.5">
                   <svg className="w-4 h-4 text-[#633806] dark:text-[#FAC775]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                 ...
                 <div className="flex-1 min-w-0">
                   <h3 className="text-sm font-semibold text-[#633806] dark:text-[#FAC775] mb-1">公告</h3>
                   <p className="text-sm text-[#633806] dark:text-[#FAC775]/90 whitespace-pre-wrap break-words">{announcement}</p>
                 </div>
               </div>
             </CardBody>
           </Card>
