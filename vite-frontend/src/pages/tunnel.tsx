          ...
          {!isBatchMode && (
            <div className="flex gap-1.5 mt-3">
              <Button
                ...
                onPress={() => onEdit(tunnel)} className="flex-1 min-h-8 text-[#D97757] bg-[#D97757]/10"
...
export default function TunnelPage() {
  ...
  const getQualityDisplay = (averageTime?: number, packetLoss?: number) => {
    ...
    if (averageTime < 100 && packetLoss < 1) return { text: '👍 良好', color: 'success' };
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {getSelectedChainNodeIds().includes(node.id) && (
                                  <Chip color="default" variant="flat" size="sm">已选为转发链</Chip>
                                )}
                              </div>
                            </div>
                          </SelectItem>
                                            ...
                                            <div className="flex items-center justify-between">
                                              ...
                                              <div className="flex items-center gap-2">
                                                ...
                                                {(form.chainNodes || []).some((group, idx) =>
                                                  ...
                                                  <Chip color="default" variant="flat" size="sm">已选为其他跳</Chip>
                                                )}
                                              </div>
                                            </div>
                                          </SelectItem>
