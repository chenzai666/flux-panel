...
export default function IndexPage() {
  ...
  return (
    <DefaultLayout>
      <section className="login-shell claude-fade-in flex flex-col items-center justify-center gap-4 py-4 sm:py-8 md:py-10 pb-20 min-h-[calc(100dvh-120px)] sm:min-h-[calc(100dvh-200px)]">
        <div className="w-full max-w-md px-4 sm:px-0 relative z-10">
          <Card className="w-full claude-panel">
            <CardHeader className="pb-0 pt-6 px-6 flex-col items-center">
              <h1 className={title({ size: "sm" })}>登录</h1>
              <p className="text-small brand-muted mt-2">欢迎回来，请继续管理您的节点与转发服务</p>
            </CardHeader>
            <CardBody className="px-6 py-6">
              <div className="flex flex-col gap-4">
                ...
                <Button
                  ...
                  isLoading={loading}
                  disabled={loading}
                  className="mt-2 bg-[#c26b2b] text-white"
                >
