    ...
    <DefaultLayout>
      <section className="flex flex-col items-center justify-center gap-4 py-4 sm:py-8 md:py-10 pb-20 min-h-[calc(100dvh-120px)] sm:min-h-[calc(100dvh-200px)]">
        <div className="w-full max-w-md px-4 sm:px-0">
          <Card className="w-full bg-white dark:bg-[#231e1b] border border-[#e5e0d8] dark:border-[#2d2824] rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            <CardHeader className="pb-0 pt-6 px-6 flex-col items-center">
              <h1 className="text-2xl font-semibold text-[#1a1a1a] dark:text-[#e8e2da]">登录</h1>
              <p className="text-sm text-[#9b9590] dark:text-[#5d5854] mt-2">请输入您的账号信息</p>
            </CardHeader>
            <CardBody className="px-6 py-6">
              <div className="flex flex-col gap-4">
                ...
                <Button
                  ...
                  isLoading={loading}
                  disabled={loading}
                  className="mt-2 bg-[#c96442] hover:bg-[#b5583a] text-white rounded-lg h-12 font-medium"
                >
