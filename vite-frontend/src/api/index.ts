...
export const forceDeleteUser = (id: number) =>
  Network.post("/user/force-delete", { id });
...
export const forceDeleteNode = (id: number) =>
  Network.post("/node/force-delete", { id });
...
export const forceDeleteTunnel = (id: number) =>
  Network.post("/tunnel/force-delete", { id });
...
export const exportConfigs = () => Network.post("/config/export");
export const importConfigs = (configs: string) =>
  Network.post("/config/import", { configs });
export const exportBackup = () => Network.post("/config/backup/export");
export const importBackup = (backup: string) =>
  Network.post("/config/backup/import", { backup });
